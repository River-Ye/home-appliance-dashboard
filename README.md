...
- 2026-07-22 08:48（台灣時間；2026-07-21 00:48 UTC）以 666 筆基準清單全量查核可信通路價格、購買連結、666 張商品圖片、437 筆 `found` 史低來源、匯率與原廠停產狀態；更新 79 筆既有商品現價（10 筆降價、69 筆漲價），並將 Marshall Heston 60 的失效 Best Buy 頁改為同型號 Marshall US 官方現貨頁；圖片連結均不需更換。17 筆 PChome Qty 0 與 Costco 明示缺貨價只保留追蹤，沒有寫回。
