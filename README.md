...
- 價格以 2026-07-11 可信通路查核的低價為準；好市多補充候選最近查核日為 2026-07-11，目前共 64 筆，每類最多 3 筆且僅挑評價不錯商品，不代表同品類全型號皆收錄。
...
- 657 筆商品皆有同型號負評／災情查核。只有同一問題由至少 6 位可辨識的獨立使用者反映、且跨至少 2 個原始網站時才顯示紅色警示；未達門檻統一顯示「截至查核日，查無達門檻的集中負評／災情」。
...
- `npm run check:data`：檢查 25 類、657 筆、必要欄位、日期格式、四類大型家電尺寸、歷史最低價與負評 research 對齊、人工覆核完成清單、逐位反映者、6 人／2 平台門檻、每類至少 20 筆、重複型號與重複購買 URL。
