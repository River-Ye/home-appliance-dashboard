...
純前端靜態頁面，整理 2026-07-20 查核的家電推薦清單，並保留好市多可購買候選，涵蓋價格、歷史最低價、負評／災情、入手時機、規格、優缺點、通路連結與海外價格 TWD 換算。
...
- 666 筆現有商品皆有同型號負評／災情查核；IRIS PCF-CDP18TEC 已以包含完整 canonical model 的 Mobile01 與 Reddit 查詢逐站覆核，未找到可成立的 exact-model 集中負評。2026-07-11 重查的 612 筆原先完全沒有負面候選商品、36 筆既有集中負評與 13 筆已有少量負面證據者則保留原研究內容。只有同一問題由至少 6 位可辨識的獨立使用者反映、且跨至少 2 個原始網站時才顯示紅色警示；未達門檻統一顯示「截至查核日，查無達門檻的集中負評／災情」。
...
- 海外價格使用 ExchangeRate-API 最新回傳的 2026-07-19 00:02 UTC 匯率換算：USD/TWD 32.34116、GBP/TWD 43.4820417810595、EUR/TWD 36.98296603269571、JPY/TWD 0.19915457788164154、CNY/TWD 4.763618688505273；17 筆外幣商品已同步重算，仍未含國際運費、進口稅與台灣保固。
