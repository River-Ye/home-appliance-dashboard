...
const extraCategoryCopy = {
  ...
  wifi: {
    label: "無線路由器",
    bestFor: "正在升級 Wi-Fi 6 以上、Mesh 或多 Gigabit 有線骨幹的家庭。",
    reason: "補入單機、Mesh 套裝、電競與高階 10G 機種，方便依戶型與串接需求比較。",
    pros: ["Wi-Fi 6 以上與 Mesh 選項完整", "可依 2.5G/10G 埠數挑選"],
    cons: ["終端裝置需支援才吃得到升級", "Mesh 套組價格、回程頻段與擺位影響大"],
    voltage: "110V 台灣通路",
  },
  blender: {
    label: "破壁機",
...
const extraProductRows = [
  ["tv", "Sony", "Y-65XR80", "BRAVIA 8 65 型 XR OLED 4K HDR Google TV 顯示器", 93900, "/items/DPAD06A900HLBJO/000001_1776334113.jpg", "DPAD06-A900HLBJO", ["65 吋 OLED", "4K HDR Google TV", "XR 影像處理", "高階 OLED"], ["OLED", "電影", "旗艦"]],
  ...
  ["tv", "Panasonic", "TV-65Z90BGT", "65 型 OLED 智慧聯網顯示器", 72072, "/items/DPAD09A900J9FAZ/000001_1761888394.jpg", "DPAD09-A900J9FAZ", ["65 吋 OLED", "智慧聯網", "4K", "日本品牌調校"], ["OLED", "電影", "均衡"]],
  ...
  ["blender", "Vitamix", "E320 Explorian", "E320 Explorian 探索者調理機雙杯組黑色", 24700, "/items/DMAY0GA900AGMD8/000001_1782460348.jpg", "DMAY0G-A900AGMD8", ["2.0L + 1.4L", "美國原裝", "Explorian 系列", "雙杯組"], ["Vitamix", "雙杯", "家用"]],
  ["blender", "Vitamix", "A2500i White", "Ascent A2500i 全食物調理機白色", 29600, "/items/QBAO0FA900AS2DJ/000001_1782460671.jpg", "QBAO0F-A900AS2DJ", ["Ascent 系列", "智能杯偵測", "全食物調理", "白色"], ["Vitamix", "智能", "家用"]],
...
function smartLockBudget(price) {
  if (price >= 24000) return "premium";
  if (price < 12000) return "value";
  return "mid";
}

function smartLockPchomeProduct(row) {
  return {
    id: row.id,
    category: "smartlock",
    rank: row.rank,
    topPick: row.topPick,
    budget: smartLockBudget(row.price),
    channel: "tw",
    brand: row.brand,
    model: row.model,
    name: row.name,
    ...
    buyLabel: "PChome",
    specs: row.specs,
    description: row.description || "電子鎖購買前要先確認門厚、門向、鎖體、天地栓與安裝條件；本清單僅列可信通路正常新品。",
    pros: row.pros || [`${row.brand} 通路能見度高`, "PChome 正常新品頁，價格與圖片可查核"],
    cons: row.cons || ["安裝前需確認門型與加價項目", "實際保固與基本安裝範圍以購買頁為準"],
    bestFor: row.bestFor,
...
const smartLockProducts = [
  smartLockPchomeProduct({
    ...
    name: "YMF-40A 四合一電子鎖",
    price: 17999,
    image: "/items/DQBS4NA900IAG1Z/000001_1754276294.jpg",
    sku: "DQBS4N-A900IAG1Z",
    specs: ["指紋/密碼/藍牙/Wi-Fi", "機械鑰匙", "含基本安裝", "Yale 台灣通路"],
    pros: ["Yale 鎖具品牌與售後通路成熟", "功能完整但價格仍在中階"],
    cons: ["非人臉/掌靜脈高階款", "需確認門厚與天地栓"],
  ...
  smartLockPchomeProduct({
    ...
    name: "YMF-30A 四合一電子鎖",
    price: 16149,
    image: "/items/DQBS4NA900I5HGS/000001_1733814561.jpg",
    sku: "DQBS4N-A900I5HGS",
    specs: ["密碼/卡片", "機械鑰匙", "含基本安裝", "手把式"],
  ...
  smartLockPchomeProduct({
    ...
    price: 25399,
    image: "/items/DQBS40A900ITUBT/000001_1747374050.jpg",
    sku: "DQBS40-A900ITUBT",
    specs: ["指紋/卡片/密碼", "Apple 認證解鎖", "藍牙/Wi-Fi", "含安裝"],
    pros: ["Apple 生態整合是少見亮點", "Yale 售後與品牌信任感高"],
    cons: ["價格高於一般四合一款", "Apple 功能需求不高者 CP 較低"],
  ...
  smartLockPchomeProduct({
    ...
    price: 23750,
    image: "/items/DQBS4NA900K6BSE/000001_1782972514.jpg",
    sku: "DQBS4N-A900K6BSE",
    specs: ["人臉/指紋/卡片/密碼", "機械鑰匙", "藍牙", "含基本安裝"],
    pros: ["人臉辨識與推拉式使用方便", "Yale 高階線功能完整"],
    cons: ["價格接近旗艦區", "庫存量較少需下單前確認"],
  ...
  smartLockPchomeProduct({
    ...
    price: 18049,
    image: "/items/DQBS4NA900I5H7X/000001_1733811821.jpg",
    sku: "DQBS4N-A900I5H7X",
    specs: ["指紋/密碼/卡片", "藍牙/Wi-Fi", "機械鑰匙", "含基本安裝"],
  ...
  smartLockPchomeProduct({
    ...
    name: "YDR-343A 電子輔助鎖",
    price: 7999,
    image: "/items/DQBS4NA900IAG3B/000001_1754286009.jpg",
    sku: "DQBS4N-A900IAG3B",
    specs: ["密碼/卡片", "藍牙/Wi-Fi", "輔助鎖", "含基本安裝"],
    pros: ["Yale 入門價最親民", "適合補強既有門鎖"],
    cons: ["輔助鎖功能不如主鎖完整", "無指紋與人臉辨識"],
  ...
  smartLockPchomeProduct({
    ...
    name: "7300 五合一把手式電子鎖",
    price: 16000,
    image: "/items/DQBS4NA900I7LS6/000001_1768190214.jpg",
    sku: "DQBS4N-A900I7LS6",
    specs: ["指紋/卡片/密碼", "機械鑰匙", "藍牙或 Wi-Fi", "含安裝"],
    pros: ["Philips 品牌辨識度高", "五合一功能價格合理"],
    cons: ["售後依代理/安裝商體系", "非推拉式旗艦"],
  ...
  smartLockPchomeProduct({
    ...
    price: 18700,
    image: "/items/DQBS4NA900JPZMY/000001_1770615435.jpg",
    sku: "DQBS4N-A900JPZMY",
    specs: ["指紋/卡片/密碼", "機械鑰匙", "Wi-Fi", "防潑水"],
    bestFor: "門口較可能接觸濕氣，仍希望選 Philips 的家庭。",
    recommendation: "防潑水取向：比 7300 貴一些，換來更明確的戶外門口使用彈性。",
    score: 88,
    tags: ["Philips", "防潑水", "五合一"],
  }),
  smartLockPchomeProduct({
    ...
    price: 23500,
    image: "/items/DQBS4NA900I7PXH/000001_1782804290.jpg",
    sku: "DQBS4N-A900I7PXH",
    specs: ["貓眼/指紋/卡片/密碼", "機械鑰匙", "Wi-Fi", "推拉式"],
  ...
  smartLockPchomeProduct({
    ...
    price: 25000,
    image: "/items/DQBS4NA900IZX3T/000001_1782804390.jpg",
    sku: "DQBS4N-A900IZX3T",
    specs: ["人臉/指紋/卡片/密碼", "貓眼", "Wi-Fi", "含安裝"],
  ...
  smartLockPchomeProduct({
    ...
    price: 32500,
    image: "/items/DQBS4NA900I7PXE/000001_1779064763.jpg",
    sku: "DQBS4N-A900I7PXE",
    specs: ["人臉/貓眼/指紋", "卡片/密碼/鑰匙", "Wi-Fi", "七合一"],
    pros: ["Philips 高階功能最完整", "人臉與貓眼適合高頻出入家庭"],
    cons: ["價格高", "功能多也更依賴安裝與設定品質"],
  ...
  smartLockPchomeProduct({
    ...
    price: 22950,
    image: "/items/DQBS4NA900JBQF3/000001_1782804231.jpg",
    sku: "DQBS4N-A900JBQF3",
    specs: ["指紋/卡片/密碼", "機械鑰匙", "Wi-Fi", "推拉式"],
    bestFor: "想要推拉式手感，但不一定需要人臉辨識的人。",
    recommendation: "Philips 推拉式均衡款：外型與功能比把手式完整，價格仍可控。",
    score: 87,
    tags: ["推拉式", "Philips", "Wi-Fi"],
  }),
  smartLockPchomeProduct({
    ...
    price: 9900,
    image: "/items/DQBS4NA900K1RGN/000001_1779784957.jpg",
    sku: "DQBS4N-A900K1RGN",
    specs: ["指紋/密碼/卡片", "機械鑰匙", "推拉式", "送安裝"],
    pros: ["推拉式價格很有競爭力", "功能比同價位入門款完整"],
    cons: ["品牌售後能見度低於 Yale/Philips", "非人臉/貓眼款"],
  ...
  smartLockPchomeProduct({
    ...
    price: 16900,
    image: "/items/DQBS4NA900JA8W9/000001_1758855158.jpg",
    sku: "DQBS4N-A900JA8W9",
    specs: ["人臉/指紋/指靜脈", "密碼/卡片/鑰匙", "推拉式", "送安裝"],
  ...
  smartLockPchomeProduct({
    ...
    price: 8900,
    image: "/items/DQBS4NA900JA8TZ/000001_1758854380.jpg",
    sku: "DQBS4N-A900JA8TZ",
    specs: ["指紋/密碼/卡片", "Wi-Fi", "機械鑰匙", "送安裝"],
  ...
  smartLockPchomeProduct({
    ...
    name: "A100 智能門鎖",
    price: 13599,
    image: "/items/DQBS4NA900I8573/000001_1749627194.png",
    sku: "DQBS4N-A900I8573",
    specs: ["指紋/密碼/卡片", "智慧家庭連動", "推拉式", "Aqara 生態"],
    pros: ["Aqara 智慧家庭整合度好", "價格比多數旗艦低"],
    cons: ["需要確認台灣安裝與保固條件", "最適合已有 Aqara 生態的人"],
  ...
  smartLockPchomeProduct({
    ...
    name: "D200i 智能門鎖",
    price: 24900,
    image: "/items/DMAAPFA900JXSH5/000001_1776828240.jpg",
    sku: "DMAAPF-A900JXSH5",
    specs: ["高階智慧門鎖", "智慧家庭連動", "指紋/密碼", "Aqara 生態"],
  ...
  smartLockPchomeProduct({
    ...
    name: "X9 指紋把手電子鎖",
    price: 11400,
    image: "/items/DQBS4NA900JJ8LG/000001_1765347346.jpg",
    sku: "DQBS4N-A900JJ8LG",
    specs: ["指紋把手", "密碼/卡片", "機械鑰匙", "中價位"],
  ...
  smartLockPchomeProduct({
    ...
    price: 25175,
    image: "/items/DQBS4NA900JUBVW/000001_1774253039.jpg",
    sku: "DQBS4N-A900JUBVW",
    specs: ["人臉/指靜脈", "密碼/卡片", "推拉式", "高階辨識"],
  ...
  smartLockPchomeProduct({
    ...
    name: "SHP-P52 推拉式電子鎖",
    price: 23275,
    image: "/items/DQBS4NA900JXYBS/000001_1776909348.jpg",
    sku: "DQBS4N-A900JXYBS",
    specs: ["APP/指紋/卡片/密碼", "機械鑰匙", "推拉式", "Samsung SHP 系列延伸"],
    pros: ["SHP 系列在電子鎖市場能見度高", "推拉式與 APP 功能完整"],
    cons: ["品牌已由 Samsung 電子鎖脈絡轉為 Zigbang", "售後需看台灣代理頁面"],
  ...
  smartLockPchomeProduct({
    ...
    name: "RL360 智慧輔助電子鎖",
    price: 10450,
    image: "/items/DXBO0TA900ENKZA/000001_1646372826.jpg",
    sku: "DXBO0T-A900ENKZA",
    specs: ["輔助電子鎖", "密碼/卡片", "原廠保固", "低門檻升級"],
    pros: ["dormakaba 鎖具品牌專業度高", "價格低於主鎖款"],
    cons: ["輔助鎖定位，功能不如主鎖", "門型相容性仍需確認"],
    bestFor: "想補強既有門鎖、不想大幅更動門體的人。",
    recommendation: "dormakaba 入門推薦：專業鎖具品牌，適合保守升級。",
    score: 84,
    tags: ["輔助鎖", "dormakaba", "低預算"],
  }),
  smartLockPchomeProduct({
    ...
    name: "ML660 四合一智能電子鎖",
    price: 23750,
    image: "/items/DECE4EA900DXNUC/000001_1643338134.jpg",
    sku: "DECE4E-A900DXNUC",
    specs: ["指紋/卡片/密碼/鑰匙", "含基本安裝", "原廠保固", "主鎖"],
    bestFor: "重視鎖具本業品牌、想要四合一主鎖的人。",
    recommendation: "專業鎖具品牌推薦：比智慧功能堆料更重視品牌與機構穩定。",
    score: 86,
    tags: ["dormakaba", "指紋", "四合一"],
  }),
  smartLockPchomeProduct({
    ...
    name: "ML770 四合一智能電子鎖",
    price: 23750,
    image: "/items/DQBS4NA900J0U5A/000001_1752128145.jpg",
    sku: "DQBS4N-A900J0U5A",
    specs: ["指紋/卡片/密碼/鑰匙", "含基本安裝", "主鎖", "四合一"],
    bestFor: "想在 dormakaba 主鎖款中比較外觀與型號差異的人。",
    recommendation: "dormakaba 主鎖備選：價格與 ML660 接近，可依門型與外觀挑選。",
    score: 85,
    tags: ["dormakaba", "四合一", "含安裝"],
  }),
  smartLockPchomeProduct({
    ...
    price: 27540,
    image: "/items/DQBS4NA900IAVXZ/000001_1740465068.jpg",
    sku: "DQBS4N-A900IAVXZ",
    specs: ["人臉辨識", "指紋/卡片/密碼", "推拉式", "含基本安裝"],
    bestFor: "想要 dormakaba 品牌加人臉辨識的高階主門。",
    recommendation: "dormakaba 旗艦推薦：人臉功能到位，但價格高於四合一款。",
    score: 86,
    tags: ["人臉", "dormakaba", "旗艦"],
  }),
  smartLockPchomeProduct({
    ...
    price: 9025,
    image: "/items/DQBS4NA900ILR7A/000001_1767853677.jpg",
    sku: "DQBS4N-A900ILR7A",
    specs: ["密碼/指紋/卡片", "輔助鎖", "含基本安裝", "韓系品牌"],
  ...
  smartLockPchomeProduct({
    ...
    name: "MI-6450 三合一電子鎖",
    price: 14250,
    image: "/items/DQBS4NA900ILR3T/000001_1767087495.jpg",
    sku: "DQBS4N-A900ILR3T",
    specs: ["卡片/密碼/鑰匙", "含基本安裝", "主鎖", "三合一"],
  ...
  smartLockPchomeProduct({
    ...
    name: "MI-7150+ 四合一電子鎖",
    price: 18050,
    image: "/items/DQBS4NA900IOJ43/000001_1766741547.jpg",
    sku: "DQBS4N-A900IOJ43",
    specs: ["指紋/卡片/密碼/鑰匙", "含基本安裝", "四合一", "黑色"],
  ...
  smartLockPchomeProduct({
    ...
    name: "FB63M 精簡電子智慧門鎖",
    price: 13775,
    image: "/items/DQBS4NA900I8ITU/000001_1753416985.jpg",
    sku: "DQBS4N-A900I8ITU",
    specs: ["細窄門框", "電子智慧門鎖", "密碼/卡片", "含安裝依頁面"],
  ...
  smartLockPchomeProduct({
    ...
    name: "FB70X 樸實電子智慧門鎖",
    price: 20900,
    image: "/items/DQAT0IA900GXIHM/000001_1764834253.jpg",
    sku: "DQAT0I-A900GXIHM",
    specs: ["APP/指紋/感應卡", "密碼/鑰匙", "抗菌塗層", "含基本安裝"],
  ...
  smartLockPchomeProduct({
    ...
    price: 42000,
    image: "/items/DQBS4NA900J43AP/000001_1764829802.jpg",
    sku: "DQBS4N-A900J43AP",
    specs: ["掌靜脈/人臉/指紋", "電子貓眼", "遠距通話", "防水/抗菌"],
    pros: ["規格完整，適合追求旗艦功能", "辨識方式多元"],
    cons: ["價格很高", "功能多，安裝與設定品質更重要"],
  ...
  smartLockPchomeProduct({
    ...
    name: "七合一人臉/貓眼掌靜脈電子鎖",
    price: 28310,
    image: "/items/DQBS4NA900IT8YL/000001_1782961750.jpg",
    sku: "DQBS4N-A900IT8YL",
    specs: ["人臉/貓眼/掌靜脈", "指紋/卡片/密碼/鑰匙", "Wi-Fi", "含安裝"],
  ...
  smartLockPchomeProduct({
    ...
    name: "和系列全自動七合一智慧鎖",
    price: 21755,
    image: "/items/DQBS4NA900JLLZ3/000001_1782963047.jpg",
    sku: "DQBS4N-A900JLLZ3",
    specs: ["3D 人臉", "指紋/卡片/密碼", "鑰匙/APP", "全自動推拉式"],
  ...
  smartLockPchomeProduct({
    ...
    name: "逸系列微光夜視貓眼電子鎖",
    price: 36860,
    image: "/items/DQBS4NA900K2QWO/000001_1782963114.jpg",
    sku: "DQBS4N-A900K2QWO",
    specs: ["300 萬畫素貓眼", "微光夜視", "七合一解鎖", "含安裝"],
    pros: ["貓眼與夜視規格清楚", "適合重視門外影像的人"],
    cons: ["價格高", "需確認網路與 APP 使用情境"],
  ...
  smartLockPchomeProduct({
    ...
    price: 12000,
    image: "/items/DECE2SA900B5V4Y/000001_1614234907.jpg",
    sku: "DECE2S-A900B5V4Y",
    specs: ["指紋", "密碼/手機", "把手款", "美國品牌"],
  ...
  smartLockPchomeProduct({
    ...
    price: 8990,
    image: "/items/DECE36A900EXHPC/000001_1776403865.jpg",
    sku: "DECE36-A900EXHPC",
    specs: ["指紋/卡片/密碼", "輔助鎖", "含標準安裝", "台灣電子鎖品牌"],
  ...
  smartLockPchomeProduct({
    ...
    price: 16910,
    image: "/items/DQBS4NA900K0KZV/000001_1779265986.jpg",
    sku: "DQBS4N-A900K0KZV",
    specs: ["指紋/卡片/密碼", "機械鑰匙", "原廠公司貨", "日系品牌"],
  ...
  smartLockPchomeProduct({
    ...
    name: "G-11 指紋密碼電子鎖",
    price: 9310,
    image: "/items/DQBS4NA900K1WBU/000001_1779862478.jpg",
    sku: "DQBS4N-A900K1WBU",
    specs: ["指紋/密碼", "卡片", "電子鎖", "入門價位"],
    bestFor: "想買日系品牌入門電子鎖、預算壓在萬元上下的人。",
    recommendation: "Panasonic 入門款：品牌安心感高，但商品頁資訊較精簡，下單前要確認安裝內容。",
    score: 80,
    tags: ["Panasonic", "低價", "指紋"],
  }),
  smartLockPchomeProduct({
    ...
    price: 6999,
    image: "/items/DQAT0BA900GKLUM/000001_1691734006.jpg",
    sku: "DQAT0B-A900GKLUM",
    specs: ["卡片/密碼", "輔助電子鎖", "韓國製造", "一次性訪客密碼"],
  ...
  smartLockPchomeProduct({
    ...
    name: "3E 小島快鎖 Z 電子鎖",
    price: 6490,
    image: "/items/DQBS3CA900HOV94/000001_1722063380.jpg",
    sku: "DQBS3C-A900HOV94",
    specs: ["電子鎖", "入門價格", "小島快鎖", "台灣通路"],
  ...
  smartLockPchomeProduct({
    ...
    price: 23750,
    image: "/items/DQBS4NA900K03FM/000001_1778558520.jpg",
    sku: "DQBS4N-A900K03FM",
    specs: ["掌靜脈", "九合一", "Wi-Fi", "含基本安裝"],
  ...
  smartLockPchomeProduct({
    ...
    name: "TK 九合一電子鎖",
    price: 30248,
    image: "/items/DQBS4NA900JG66I/000001_1771990337.jpg",
    sku: "DQBS4N-A900JG66I",
    specs: ["人臉/掌靜脈/指紋", "密碼/鑰匙", "Wi-Fi", "九合一"],
  ...
  smartLockPchomeProduct({
    ...
    name: "T12 五合一把手式電子鎖",
    price: 14155,
    image: "/items/DQBS4NA900IDEPI/000001_1748323634.jpg",
    sku: "DQBS4N-A900IDEPI",
    specs: ["指紋/卡片/密碼", "鑰匙/遠端 APP", "把手式", "含基本安裝"],
  ...
  smartLockPchomeProduct({
    ...
    price: 22230,
    image: "/items/DQBS4NA900J5GYW/000001_1755762130.jpg",
    sku: "DQBS4N-A900J5GYW",
    specs: ["全自動", "指紋/密碼", "電子鎖", "台灣通路"],
  ...
  smartLockPchomeProduct({
    ...
    price: 32138,
    image: "/items/DQBS4NA900JISCM/000001_1780306235.jpg",
    sku: "DQBS4N-A900JISCM",
    specs: ["指靜脈", "貓眼", "智慧靜音", "高階款"],
  ...
  smartLockPchomeProduct({
    ...
    price: 39800,
    image: "/items/DQBS4NA900K2WIC/000001_1783308785.jpg",
    sku: "DQBS4N-A900K2WIC",
    specs: ["12 合 1", "人臉/指紋/掌靜脈", "日本製", "高階款"],
  ...
  smartLockPchomeProduct({
    ...
    price: 49800,
    image: "/items/DQBS4NA900K2STR/000001_1783309040.jpg",
    sku: "DQBS4N-A900K2STR",
    specs: ["13 合 1", "人臉/指紋/掌靜脈", "日本製", "旗艦款"],
    pros: ["功能規格最滿", "日本製與外觀用料有特色"],
    cons: ["價格是本類最高級距", "CP 值不如中階品牌款"],
...
function wifiRouterBudget(price) {
  if (price >= 9000) return "premium";
  if (price < 3000) return "value";
  return "mid";
}

function wifiRouterPchomeProduct(row) {
  const meshText = row.mesh || "未特別標示";
  const meshSupported = !meshText.includes("未特別");
  return {
    id: row.id,
    category: "wifi",
    rank: row.rank,
    topPick: row.topPick,
    budget: row.budget || wifiRouterBudget(row.price),
    channel: "tw",
    brand: row.brand,
    model: row.model,
    name: row.name,
    ...
    description: row.description || `${row.brand} ${row.model} 是 Wi-Fi 6 以上無線路由器，已排除網卡、延伸器、交換器與福利/展示/拆封品。`,
    pros: row.pros || [
      meshSupported ? "可作為多台串接/全屋覆蓋候選" : "單機路由規格清楚、適合集中式擺放",
      "台灣可信通路新品，價格與圖片可查核",
    ],
    cons: row.cons || [
      meshSupported ? "Mesh 效果仍受擺位、牆面與回程頻段影響" : "未特別標示 Mesh，不建議作為 2-3 台串接首選",
...
const wifiRouterProducts = [
  wifiRouterPchomeProduct({
    ...
    price: 5999,
    image: "/items/DRAF01A900I3ETA/000001_1759801067.jpg",
    sku: "DRAF01-A900I3ETA",
    standard: "Wi-Fi 7",
    speed: "BE5000 雙頻",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 7499,
    image: "/items/DRAFJ6A900JL8Q9/000001_1766717579.jpg",
    sku: "DRAFJ6-A900JL8Q9",
    standard: "Wi-Fi 7",
    speed: "BE3600 雙頻",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 3499,
    image: "/items/DRAFLPA900JKWXK/000001_1782952070.jpg",
    sku: "DRAFLP-A900JKWXK",
    standard: "Wi-Fi 7",
    speed: "BE3600 雙頻",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 11999,
    image: "/items/DRAN08A900H851Z/000001_1782099268.jpg",
    sku: "DRAN08-A900H851Z",
    standard: "Wi-Fi 7",
    speed: "BE11000 三頻",
    mesh: "支援 Deco Mesh，二入組",
    ports: "全 2.5G",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 9900,
    image: "/items/DRAFJAA900JG5AK/000001_1763014538.jpg",
    sku: "DRAFJA-A900JG5AK",
    standard: "Wi-Fi 7",
    speed: "BE5000 雙頻",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 2990,
    image: "/items/DRAFL7A900IJMF6/000001_1744352670.jpg",
    sku: "DRAFL7-A900IJMF6",
    standard: "Wi-Fi 6E",
    speed: "AXE5400 三頻",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 6899,
    image: "/items/DRAGCMA900FQ3JZ/000001_1681110575.png",
    sku: "DRAGCM-A900FQ3JZ",
    standard: "Wi-Fi 6",
    speed: "AX3000 雙頻",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 4999,
    image: "/items/DRAFLPA900IV4B6/000001_1782965267.jpg",
    sku: "DRAFLP-A900IV4B6",
    standard: "Wi-Fi 7",
    speed: "BE6500 雙頻",
    mesh: "支援 AiMesh",
    ports: "2.5G/Gigabit 依商品頁",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 7999,
    image: "/items/DRAFJBA900I4F5A/000001_1780372394.jpg",
    sku: "DRAFJB-A900I4F5A",
    standard: "Wi-Fi 7",
    speed: "BE15000 三頻",
    mesh: "支援 EasyMesh",
    ports: "10G + 多 Gigabit",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 5299,
    image: "/items/DRAFJ6A900IZ71A/000001_1755490950.jpg",
    sku: "DRAFJ6-A900IZ71A",
    standard: "Wi-Fi 7",
    speed: "BE9500 三頻",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 5490,
    image: "/items/DRAF02A900I473A/000001_1732699929.jpg",
    sku: "DRAF02-A900I473A",
    standard: "Wi-Fi 7",
    speed: "BE11000 三頻",
    mesh: "支援 Mesh",
    ports: "2.5G/Gigabit 依商品頁",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 4199,
    image: "/items/DRAFEMA900F9H1Y/000001_1774858877.jpg",
    sku: "DRAFEM-A900F9H1Y",
    standard: "Wi-Fi 6",
    speed: "AX3000 雙頻",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 2159,
    image: "/items/DYANAIA900HNEUP/000001_1730700224.jpg",
    sku: "DYANAI-A900HNEUP",
    standard: "Wi-Fi 6",
    speed: "AX3000 雙頻",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 2290,
    image: "/items/DRAFLVA900K13CR/000001_1779257487.jpg",
    sku: "DRAFLV-A900K13CR",
    standard: "Wi-Fi 7",
    speed: "BE3600 雙頻",
    mesh: "未特別標示 Mesh",
    ports: "Gigabit 有線埠",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 1890,
    image: "/items/DSBC1TA900IR9CO/000001_1746532107.jpg",
    sku: "DSBC1T-A900IR9CO",
    standard: "Wi-Fi 7",
    speed: "BE3600 雙頻",
    mesh: "未特別標示 Mesh",
    ports: "2.5G + Gigabit",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 1990,
    image: "/items/DRAFJDA900JJ4D4/000001_1765268990.jpg",
    sku: "DRAFJD-A900JJ4D4",
    standard: "Wi-Fi 7",
    speed: "BE5100 雙頻",
    mesh: "支援 Mesh",
    ports: "Gigabit 有線埠",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 2599,
    image: "/items/DRAFJ6A900JFC98/000001_1782210759.jpg",
    sku: "DRAFJ6-A900JFC98",
    standard: "Wi-Fi 7",
    speed: "BE3600 雙頻",
    mesh: "支援 AQUILA PRO AI Mesh",
    ports: "2.5G + Gigabit",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 4095,
    image: "/items/DRAFJAA900JUQYP/000001_1774520642.jpg",
    sku: "DRAFJA-A900JUQYP",
    standard: "Wi-Fi 7",
    speed: "BE3600 雙頻",
    mesh: "未特別標示 Mesh",
    ports: "Gigabit 有線埠",
    ...
    score: 78,
    tags: ["NETGEAR", "單台", "Wi-Fi 7", "Nighthawk"],
  }),
  wifiRouterPchomeProduct({
    ...
    price: 10990,
    image: "/items/DRAFE5A900JUA8C/000001_1774227439.jpg",
    sku: "DRAFE5-A900JUA8C",
    standard: "Wi-Fi 6",
    speed: "AX5400 雙頻",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 9999,
    image: "/items/DQBS4VA900JIQU0/000001_1764896894.jpg",
    sku: "DQBS4V-A900JIQU0",
    standard: "Wi-Fi 6",
    speed: "AX6600 三頻",
    mesh: "未特別標示 Mesh",
    ports: "2.5G + Gigabit",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 9999,
    image: "/items/DRAFJ5A900HRBD9/000001_1760580708.jpg",
    sku: "DRAFJ5-A900HRBD9",
    standard: "Wi-Fi 7",
    speed: "BE7200 雙頻",
    mesh: "支援 AiMesh",
    ports: "多 Gigabit / 10G 依商品頁",
    bestFor: "有多台有線設備、NAS、遊戲主機，並想保留 AiMesh 的進階使用者。",
    recommendation: "高階 ASUS 推薦：有線擴充與韌體功能強，但一般家庭可先看 ZenWiFi/RT-BE58U。",
    score: 77,
    tags: ["AiMesh", "高階", "ASUS", "多埠"],
  }),
  wifiRouterPchomeProduct({
    ...
    price: 12999,
    image: "/items/DRAN5BA900HQT2A/000001_1780372414.jpg",
    sku: "DRAN5B-A900HQT2A",
    standard: "Wi-Fi 7",
    speed: "BE19000 三頻",
    mesh: "未特別標示 Mesh",
    ports: "雙 10G",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 16999,
    image: "/items/DRAN5BA900HF2LS/000001_1782099036.jpg",
    sku: "DRAN5B-A900HF2LS",
    standard: "Wi-Fi 7",
    speed: "BE24000 四頻",
    mesh: "未特別標示 Mesh",
    ports: "雙 10G",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 8700,
    image: "/items/DRAFJAA900IFBVA/000001_1780997121.jpg",
    sku: "DRAFJA-A900IFBVA",
    standard: "Wi-Fi 7",
    speed: "BE9300 三頻",
    mesh: "未特別標示 Mesh",
    ports: "2.5G/Gigabit 依商品頁",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 6480,
    image: "/items/DRAF0IA900HO2DR/000001_1777023675.jpg",
    sku: "DRAF0I-A900HO2DR",
    standard: "Wi-Fi 6",
    speed: "AX6000 雙頻",
    mesh: "未特別標示 Mesh",
    ports: "Gigabit 有線埠",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 7990,
    image: "/items/DRAFKSA900HEQVN/000001_1713512948.jpg",
    sku: "DRAFKS-A900HEQVN",
    standard: "Wi-Fi 6E",
    speed: "AXE6600 三頻",
    mesh: "未特別標示 Mesh",
    ports: "2.5G/Gigabit 依商品頁",
  ...
  wifiRouterPchomeProduct({
    ...
    name: "Wi-Fi 7 路由器",
    price: 2990,
    image: "/items/DRAFJ8A900JSZV4/000001_1773200906.jpg",
    sku: "DRAFJ8-A900JSZV4",
    standard: "Wi-Fi 7",
    speed: "BE3600 雙頻",
    mesh: "支援 Mesh",
    ports: "Gigabit 有線埠",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 1199,
    image: "/items/DYANAIA900HNETW/000001_1730700267.jpg",
    sku: "DYANAI-A900HNETW",
    standard: "Wi-Fi 6",
    speed: "AX3000 雙頻",
    mesh: "支援 Xiaomi Mesh",
    ports: "Gigabit 有線埠",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 891,
    image: "/items/DRAFJ8A900JNW9S/000001_1768979044.jpg",
    sku: "DRAFJ8-A900JNW9S",
    standard: "Wi-Fi 6",
    speed: "AX3000 雙頻",
    mesh: "支援 Mesh",
    ports: "Gigabit 有線埠",
    ...
    score: 73,
    tags: ["Mesh", "最低價", "TOTOLINK", "Wi-Fi 6"],
  }),
  wifiRouterPchomeProduct({
    ...
    price: 7990,
    image: "/items/DRAG6JA900AUW3D/000001_1626400932.jpg",
    sku: "DRAG6J-A900AUW3D",
    standard: "Wi-Fi 6",
    speed: "AX3600 雙頻",
    mesh: "未特別標示 Mesh",
    ports: "雙 10GbE",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 1720,
    image: "/items/DRAFJ8A900JX7UY/000001_1776333176.jpg",
    sku: "DRAFJ8-A900JX7UY",
    standard: "Wi-Fi 6",
    speed: "AX3000 雙頻",
    mesh: "支援 Mesh",
    ports: "2.5G + Gigabit",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 1790,
    image: "/items/DRAFLTA900JMCU4/000001_1776166910.jpg",
    sku: "DRAFLT-A900JMCU4",
    standard: "Wi-Fi 7",
    speed: "BE3600 雙頻",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 3299,
    image: "/items/DRAFJ5A900K6OV8/000001_1783069758.jpg",
    sku: "DRAFJ5-A900K6OV8",
    standard: "Wi-Fi 7",
    speed: "BE3600 雙頻",
    mesh: "支援 AiMesh",
    ports: "Gigabit 有線埠",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 2699,
    image: "/items/DSBC5UA900J0QSL/000001_1779184048.jpg",
    sku: "DSBC5U-A900J0QSL",
    standard: "Wi-Fi 7",
    speed: "BE3600 雙頻",
  ...
  wifiRouterPchomeProduct({
    ...
    price: 4699,
    image: "/items/DRAFJ9A900IZ7Y3/000001_1753463373.jpg",
    sku: "DRAFJ9-A900IZ7Y3",
    standard: "Wi-Fi 7",
    speed: "BE3600 雙頻",
...
products.splice(
  0,
  products.length,
  ...products.filter((product) => product.category !== "robot" && product.category !== "wifi"),
