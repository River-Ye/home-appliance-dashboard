...
const eur = (amount) => ({ currency: "EUR", amount, converted: Math.round(amount * exchange.EUR_TWD), confidence: "海外參考價" });
...
const extraProductRows = [
  ["tv", "Sony", "Y-65XR80", "BRAVIA 8 65 型 XR OLED 4K HDR Google TV 顯示器", 93900, "/items/DPAD061900IXOLE/000001_1761631712.jpg", "DPAD06-1900IXOLE", ["65 吋 OLED", "4K HDR Google TV", "XR 影像處理", "含壁掛/情境燈組"], ["OLED", "電影", "旗艦"]],
  ["tv", "LG", "OLED65G5PTA", "65 型 OLED evo G5 零間隙藝廊系列 4K 顯示器", 109990, "/items/DPADYE1900JGOXW/000001_1778348697.jpg", "DPADYE-1900JGOXW", ["65 吋 OLED evo", "4K 120Hz", "零間隙藝廊設計", "AI 物聯網智慧顯示器"], ["OLED", "藝廊", "旗艦"]],
  ["tv", "Panasonic", "TV-65Z90BGT", "65 型 OLED 智慧聯網顯示器", 72072, "/items/DPAD09A900J98HS/000001_1782973413.jpg", "DPAD09-A900J98HS", ["65 吋 OLED", "智慧聯網", "4K", "日本品牌調校"], ["OLED", "電影", "均衡"]],
  ...
  ["tv", "TCL", "S Pro mini 65", "65 型 4K Mini LED DLG 288Hz Google TV 顯示器", 26999, "/items/DPADBU1900JC97W/000001_1761379704.jpg", "DPADBU-1900JC97W", ["65 吋 Mini LED", "DLG 288Hz", "AirPlay 2", "Google TV"], ["Mini LED", "遊戲", "CP 值"]],
  ...
  ["soundbar", "Samsung", "HW-Q800H/ZW", "Q 系列 5.1.2 聲道 Soundbar 家庭劇院", 35900, "/items/DMAAODA900K53X0/000001_1782210112.jpg", "DMAAOD-A900K53X0", ["5.1.2 聲道", "重低音", "Dolby Atmos", "Q 系列"], ["Atmos", "重低音", "均衡"]],
  ...
  ["soundbar", "Sony", "HT-S40R", "5.1 聲道 Soundbar 家庭劇院組", 9490, "/items/DMAAECA900BFLRR/000001_1622769045.jpg", "DMAAEC-A900BFLRR", ["5.1 聲道", "後環繞", "重低音", "藍牙"], ["CP 值", "入門劇院", "Sony"]],
  ["soundbar", "Sony", "HT-S100F", "2.0 聲道單件式藍牙 Soundbar", 7990, "/items/DMAAMTA900I5HHO/000001_1778661010.jpg", "DMAAMT-A900I5HHO", ["2.0 聲道", "單件式", "藍牙", "小空間"], ["小空間", "入門", "簡潔"]],
  ["soundbar", "JBL", "BAR 300 MK2", "BAR 300MK2 5.0 聲道 Soundbar", 15800, "/items/DMAAHGA900JCY2V/000001_1760766812.jpg", "DMAAHG-A900JCY2V", ["5.0 聲道", "Dolby Atmos", "單件式", "黑/白色"], ["JBL", "小客廳", "均衡"]],
  ["soundbar", "JBL", "BAR 800 MK2", "7.1 聲道家庭劇院喇叭", 32800, "/items/DMAANIA900J55KC/000001_1755243715.jpg", "DMAANI-A900J55KC", ["7.1 聲道", "無線後環繞", "重低音", "家庭劇院"], ["JBL", "後環繞", "客廳"]],
  ["soundbar", "Bose", "Smart Soundbar", "家庭娛樂揚聲器 Smart Soundbar", 19900, "/items/DMAANJA900HZBZV/000001_1729154632.jpg", "DMAANJ-A900HZBZV", ["單件式聲霸", "智慧連線", "Bose 調音", "家庭娛樂"], ["Bose", "音樂", "簡潔"]],

  ["fan", "Panasonic", "F-S16LMD", "16 吋 DC 變頻電風扇", 3090, "/items/DMABLMA900EOROV/000001_1757038312.jpg", "DMABLM-A900EOROV", ["16 吋", "DC 變頻", "立扇", "節能"], ["DC", "16 吋", "CP 值"]],
  ["fan", "Panasonic", "F-H14GND-K", "14 吋 DC 微電腦定時電風扇", 4090, "/items/DMABLMA900EOQ12/000001_1695005225.jpg", "DMABLM-A900EOQ12", ["14 吋", "DC 馬達", "負離子", "ECO 溫控"], ["DC", "負離子", "臥室"]],
  ["fan", "Panasonic", "F-H14LXD-K", "14 吋 DC 微電腦定時電風扇", 4900, "/items/DMABLMA900EORP0/000001_1697161466.jpg", "DMABLM-A900EORP0", ["14 吋", "DC 馬達", "定時", "遙控"], ["DC", "高階", "臥室"]],
  ["fan", "Panasonic", "F-S14KM", "14 吋微電腦 DC 直流電風扇", 1450, "/items/DMAB1FA900EZLVB/000001_1685607577.jpg", "DMAB1F-A900EZLVB", ["14 吋", "DC 直流", "微電腦", "台灣製造"], ["DC", "低價", "租屋"]],
  ["fan", "Panasonic", "F-L16GMD", "16 吋 DC 變頻高級型溫感遙控電風扇", 3590, "/items/DMAB30A900EOQ5X/000001_1693793932.jpg", "DMAB30-A900EOQ5X", ["16 吋", "DC 變頻", "溫感", "遙控"], ["DC", "溫控", "客廳"]],
  ["fan", "Panasonic", "F-S14QT", "14 吋五片扇葉 ECO 溫度感知 DC 馬達電風扇", 2690, "/items/DMABLMA900JUGZR/000001_1774429228.jpg", "DMABLM-A900JUGZR", ["14 吋", "五片扇葉", "ECO 溫度感知", "附遙控器"], ["DC", "溫控", "CP 值"]],
  ["fan", "Panasonic", "F-S12QT", "12 吋五片扇葉 ECO 溫度感知 DC 馬達電風扇", 2390, "/items/DMABLMA900JUH1F/000001_1774429172.jpg", "DMABLM-A900JUH1F", ["12 吋", "五片扇葉", "ECO 溫控", "附遙控器"], ["小空間", "DC", "臥室"]],
  ...
  ["circulator", "Vornado", "52-TW", "52-TW 黑色渦流空氣循環扇", 2730, "/items/DMAB15A900IIGFV/000001_1765275212.jpg", "DMAB15-A900IIGFV", ["渦流循環", "桌上/地面", "黑色", "小坪數"], ["渦流", "小空間", "Vornado"]],
  ["circulator", "Vornado", "62-TW", "62-TW 黑色渦流空氣循環扇", 3880, "/items/DMAB3XA900IIGO1/000001_1765272569.jpg", "DMAB3X-A900IIGO1", ["渦流循環", "中坪數", "黑色", "強風量"], ["渦流", "客廳", "Vornado"]],
  ["circulator", "Vornado", "VF20", "7.5 吋經典復古循環扇綠色", 5895, "/items/QBAF31A900ARWXH/000001_1765269049.jpg", "QBAF31-A900ARWXH", ["7.5 吋", "復古外型", "金屬風格", "循環扇"], ["復古", "設計", "小空間"]],
  ["circulator", "Vornado", "RTRHD-TW", "RTRHD-TW 渦流空氣循環機", 5580, "/items/DMAB3XA900HXMO2/000001_1782713138.jpg", "DMAB3X-A900HXMO2", ["渦流循環", "高風量", "循環機", "客廳用"], ["渦流", "高風量", "客廳"]],
  ...
  ["circulator", "Vornado", "6303DC", "6303DC 白色渦流空氣循環機", 6980, "/items/QBAF31A9008YBED/000001_1765269212.jpg", "QBAF31-A9008YBED", ["DC 馬達", "白色", "渦流循環", "中大坪數"], ["DC", "渦流", "高階"]],
  ["circulator", "Vornado", "EXO61HD-TW", "EXO61HD-TW 渦流空氣循環機", 4482, "/items/DMAB3XA900HN9W0/000001_1782713517.jpg", "DMAB3X-A900HN9W0", ["渦流循環", "中階價位", "循環機", "耐用取向"], ["渦流", "均衡", "客廳"]],
  ["circulator", "IRIS OHYAMA", "TAF-MKM10", "極靜音自動擺動空氣循環扇", 749, "/items/DMABLLA900IJ6JP/000001_1744101771.jpg", "DMABLL-A900IJ6JP", ["桌上扇", "自動擺動", "極靜音", "小坪數"], ["低價", "桌上", "臥室"]],
  ...
  ["dehumidifier", "Panasonic", "F-YV32NXK", "16 公升變頻高效型除濕機磁石黑", 17010, "/items/DMBQ3PA900I5LU9/000001_1733904936.jpg", "DMBQ3P-A900I5LU9", ["16 公升", "變頻", "一級能效", "磁石黑"], ["16L", "變頻", "節能"]],
  ...
  ["dehumidifier", "Panasonic", "F-Y16FH", "8 公升清淨除濕機", 13290, "/items/DMAU0FA900B1HPU/000001_1782813379.jpg", "DMAU0F-A900B1HPU", ["8 公升", "清淨除濕", "小坪數", "省空間"], ["8L", "小坪數", "清淨"]],
  ["dehumidifier", "Panasonic", "F-Y16FH", "8 公升智慧節能除濕機", 11961, "/items/DMAU0FA9009HC8X/000001_1581487025.jpg", "DMAU0F-A9009HC8X", ["8 公升", "智慧節能", "小坪數", "清淨除濕"], ["8L", "節能", "臥室"]],
  ...
  ["dehumidifier", "LG", "DD121MWE0", "PuriCare 12 公升雙變頻除濕機", 17900, "/items/DMBQ07A900I767E/000001_1767339532.jpg", "DMBQ07-A900I767E", ["12 公升", "雙變頻", "PuriCare", "白色"], ["LG", "12L", "變頻"]],
  ...
  ["dehumidifier", "LG", "DD201MEE0", "19.6 公升 PuriCare 雙變頻除濕機米色", 21300, "/items/DMBQ4OA900JX7GH/000001_1782957608.jpg", "DMBQ4O-A900JX7GH", ["19.6 公升", "雙變頻", "米白色", "一級能效"], ["LG", "19.6L", "節能"]],
  ["dehumidifier", "LG", "DE221MWE0", "22 公升 WiFi 雙變頻除濕機時尚款", 22900, "/items/DMBQ07A900JOMT2/000001_1769582692.jpg", "DMBQ07-A900JOMT2", ["22 公升", "WiFi", "雙變頻", "大坪數"], ["LG", "22L", "WiFi"]],

  ["purifier", "Blueair", "HINSPure CP9i", "HINSPure 紫藍光高效抑菌空氣清淨機", 26990, "/items/DMAUE4A900IJCAP/000001_1780654528.jpg", "DMAUE4-A900IJCAP", ["22-43 坪", "紫藍光抑菌", "高效濾淨", "智慧清淨"], ["大坪數", "抑菌", "高階"]],
  ["purifier", "Blueair", "Blue Signature SP4i", "Blue Signature SP4i 極夜藍空氣清淨機", 19990, "/items/DMAUE4A900J9KNK/000001_1780654611.jpg", "DMAUE4-A900J9KNK", ["22-39 坪", "智慧清淨", "大坪數", "極夜藍"], ["大坪數", "Blueair", "設計"]],
  ["purifier", "Blueair", "BlueMax 3250i", "BlueMax 智能 WiFi 空氣清淨機 3250i", 4990, "/items/DMAUE4A900I7DJ1/000001_1780654701.jpg", "DMAUE4-A900I7DJ1", ["8-12 坪", "WiFi", "輕巧", "除異味"], ["小坪數", "WiFi", "CP 值"]],
  ["purifier", "Blueair", "BlueMax 3350i", "BlueMax 智能 WiFi 空氣清淨機 3350i", 7990, "/items/DMAUE4A900I7DN1/000001_1780654653.jpg", "DMAUE4-A900I7DN1", ["15-24 坪", "WiFi", "輕巧", "除異味"], ["中坪數", "WiFi", "均衡"]],
  ["purifier", "Blueair", "ComfortPure T20i", "ComfortPure 智能三合一涼暖空氣清淨機", 17990, "/items/DMAUE4A900J40NE/000001_1780654570.jpg", "DMAUE4-A900J40NE", ["15-19 坪", "涼暖三合一", "智慧控制", "空氣清淨"], ["涼暖", "三合一", "臥室"]],
  ["purifier", "Blueair", "HINSPure CP7i", "HINSPure 紫藍光高效抑菌空氣清淨機", 22990, "/items/DMAU1FA900IJCA6/000001_1780654549.jpg", "DMAU1F-A900IJCA6", ["16-33 坪", "紫藍光抑菌", "高效濾淨", "中大坪數"], ["抑菌", "中大坪數", "Blueair"]],
  ["purifier", "Dyson", "HP12", "Purifier Hot+Cool De-NOx 甲醛 NOx 偵測涼暖空氣清淨機", 26900, "/items/DMAU3CA900I7ORK/000001_1782810487.jpg", "DMAU3C-A900I7ORK", ["涼暖二合一", "甲醛/NOx 偵測", "空氣清淨", "Dyson app"], ["涼暖", "偵測", "旗艦"]],
  ...
  ["purifier", "MUJI", "AC0650", "奈米級空氣清淨機", 4990, "/items/DMAC2OA900GD1ZV/000001_1781800174.jpg", "DMAC2O-A900GD1ZV", ["奈米級濾淨", "簡約外型", "小坪數", "入門價位"], ["小坪數", "低價", "簡約"]],
  ...
  ["vacuum", "Dyson", "V12s Origin Submarine SV49", "V12s Origin Submarine 乾濕全能洗地吸塵器", 18900, "/items/DMAX001900JRA9W/000001_1780465600.jpg", "DMAX00-1900JRA9W", ["乾濕全能", "Submarine 洗地", "雙主吸頭", "SV49"], ["洗地", "Dyson", "寵物"]],
  ["vacuum", "Dyson", "V15 Detect Fluffy SV47", "V15 Detect Fluffy 智慧無線吸塵器", 19900, "/items/DMAX001900J3508/000001_1780280214.jpg", "DMAX00-1900J3508", ["無線吸塵", "Detect 顯塵", "除螨", "SV47"], ["顯塵", "Dyson", "高吸力"]],
  ["vacuum", "Dyson", "V8 Focus Mattress HH15", "V8 Focus Mattress origin 強勁無線除塵螨機", 7990, "/items/DMAX00A900HC5BZ/000001_1780458569.jpg", "DMAX00-A900HC5BZ", ["除塵螨", "手持無線", "床墊清潔", "HH15"], ["除螨", "手持", "CP 值"]],
  ["vacuum", "LG", "CordZero A9X-STEAM", "CordZero A9X 蒸氣濕拖自動集塵無線吸塵器", 26900, "/items/DMAX8KA900HLXAQ/000001_1744871444.jpg", "DMAX8K-A900HLXAQ", ["280W 吸力", "蒸氣濕拖", "自動集塵", "LCD 螢幕"], ["自動集塵", "蒸氣", "LG"]],
  ...
  ["vacuum", "LG", "CordZero A9 Air", "CordZero A9 Air 輕量美型無線吸塵器雪霧白", 10900, "/items/DMAX2CA900JWK5M/000001_1779934057.jpg", "DMAX2C-A900JWK5M", ["無線吸塵", "輕量", "雪霧白", "A9 Air"], ["LG", "輕量", "均衡"]],
  ["vacuum", "Tineco", "Switch S7 Stretch", "Switch S7 Stretch 無線多工平躺速乾洗地吸塵器", 18880, "/items/DMAXB5A900JFCJP/000001_1762402803.jpg", "DMAXB5-A900JFCJP", ["22000Pa", "5 分鐘速乾", "85 度熱水洗", "一機五用"], ["洗地", "平躺", "熱水洗"]],
  ...
  ["wifi", "Mercusys", "MR27BE", "MR27BE Wi-Fi 7 BE3600 雙頻路由器", 2299, "/items/DRAFJ9A900HSRT9/000001_1755483449.jpg", "DRAFJ9-A900HSRT9", ["Wi-Fi 7", "BE3600", "雙 2.5G", "EasyMesh"], ["低價", "Wi-Fi 7", "入門"]],
  ...
  ["wifi", "TP-Link", "Deco BE22", "Deco BE22 Wi-Fi 7 BE3600 Mesh 單入組", 2899, "/items/DRAN08A900J0G05/000001_1770719601.jpg", "DRAN08-A900J0G05", ["Wi-Fi 7", "BE3600", "單入 Mesh", "雙 1G 埠"], ["Mesh", "入門", "小宅"]],
  ...
  ["blender", "Vitamix", "VITA PREP 3", "VITA PREP3 多功能營養調理機", 28000, "/items/QBAO0FA9008QMKY/000001_1782719571.jpg", "QBAO0F-A9008QMKY", ["3 匹馬力", "高轉速", "美國原廠貨", "商家用"], ["Vitamix", "旗艦", "高馬力"]],
  ...
  ["blender", "Joyoung", "L19N-Y1W", "1.2L 高速調理果汁機", 1490, "/items/DMAYGBA900J3NK0/000001_1767836794.jpg", "DMAYGB-A900J3NK0", ["1.2L", "高速調理", "果汁/冰沙", "入門價位"], ["Joyoung", "低價", "小家庭"]],
  ["blender", "Kaiqi", "KQ-PB1500", "全自動豆漿機破壁機多功能料理機", 3793, "/items/DMAY4YA900J7NYF/000001_1757141350.jpg", "DMAY4Y-A900J7NYF", ["加熱豆漿", "破壁料理", "高硼玻璃", "多功能"], ["加熱", "豆漿", "CP 值"]],

  ["oven", "Fujitek", "OM27-M54", "微波大師 27L 氣炸烤箱微波爐", 8990, "/items/DMBJ02A900I9LQ2/000001_1782379010.jpg", "DMBJ02-A900I9LQ2", ["27L", "微波/烤箱/氣炸", "乾果/舒肥/優格", "質感黑"], ["多合一", "CP 值", "小家庭"]],
  ["oven", "Whirlpool", "AMW-90TW", "25.5L 旗艦級三合一多功能微波氣炸烤箱", 9999, "/items/DMBJ6GA900J947G/000001_1757918714.jpg", "DMBJ6G-A900J947G", ["25.5L", "微波", "氣炸", "烤箱"], ["Whirlpool", "多合一", "CP 值"]],
  ["oven", "Panasonic", "NN-BS1700", "30L 蒸氣烘烤微波爐", 32900, "/items/DMBJ021900HCI1L/000001_1778836812.jpg", "DMBJ02-1900HCI1L", ["30L", "蒸氣烘烤", "微波", "高階水波爐"], ["Panasonic", "蒸烤", "旗艦"]],
  ["oven", "Whirlpool", "MWP329TST", "Coloris 系列 32L 8 合 1 變頻氣炸蒸烤微波爐", 22900, "/items/DMBJ0RA900IVQ0H/000001_1751943219.jpg", "DMBJ0R-A900IVQ0H", ["32L", "8 合 1", "變頻", "氣炸蒸烤微波"], ["Whirlpool", "32L", "多合一"]],
  ["oven", "Whirlpool", "MWP329TST Brown", "Coloris 32 公升 8 合 1 全能變頻氣炸蒸烤微波爐", 22900, "/items/DMBJ03A900IYX0L/000001_1750758530.jpg", "DMBJ03-A900IYX0L", ["32L", "8 合 1", "大地棕", "變頻"], ["Whirlpool", "32L", "設計"]],
  ["oven", "Whirlpool", "MWP269TMT White", "Coloris 26 公升 8 合 1 全能變頻氣炸蒸烤微波爐", 16900, "/items/DMBJ02A900J1WEX/000001_1753093870.jpg", "DMBJ02-A900J1WEX", ["26L", "8 合 1", "雲霧白", "變頻"], ["Whirlpool", "26L", "多合一"]],
  ["oven", "SHARP", "AX-XW10T", "AIoT 智慧連網 30L 水波爐蒸氣烘烤微波爐", 38800, "/items/DMBJ02A900G81GH/000001_1751535138.jpg", "DMBJ02-A900G81GH", ["30L", "水波爐", "AIoT", "蒸氣烘烤微波"], ["SHARP", "水波爐", "旗艦"]],
  ["oven", "SHARP", "AX-XP10T", "30 公升 Healsio 炙燒水波爐", 28800, "/items/DMBJ021900I5KFC/000001_1779346148.jpg", "DMBJ02-1900I5KFC", ["30L", "Healsio", "水波爐", "炙燒"], ["SHARP", "水波爐", "蒸烤"]],
  ...
  ["oven", "Panasonic", "NN-BS807", "30L 旋鈕平台式變頻蒸烘烤微波爐", 22410, "/items/DMBJ0GA900AZT38/000001_1630038428.jpg", "DMBJ0G-A900AZT38", ["30L", "變頻", "蒸烘烤", "平台式"], ["Panasonic", "蒸烤", "均衡"]],
  ...
  ["bidet", "Panasonic", "DL-F610RTWS", "儲熱式溫水洗淨便座含原廠基本安裝", 6990, "/items/DMAL8LA900AMAOT/000001_1760406979.jpg", "DMAL8L-A900AMAOT", ["儲熱式", "溫水洗淨", "含基本安裝", "入門價位"], ["Panasonic", "低價", "安裝"]],
  ["bidet", "Panasonic", "DL-RT30TWWS", "纖薄美型瞬熱式溫水洗淨便座", 17900, "/items/DMAL6WA900IDWC5/000001_1740448947.jpg", "DMAL6W-A900IDWC5", ["瞬熱式", "纖薄設計", "溫水洗淨", "美型"], ["Panasonic", "瞬熱", "設計"]],
  ["bidet", "Panasonic", "DL-PU30TWWS", "瞬熱式溫水洗淨便座", 13900, "/items/DMAL6WA900JG1BJ/000001_1762939118.jpg", "DMAL6W-A900JG1BJ", ["瞬熱式", "溫水洗淨", "溫控", "家用"], ["Panasonic", "瞬熱", "均衡"]],
...
const extraProducts = extraProductRows.map(([category, brand, model, name, price, image, sku, specs, tags]) => {
  ...
  return {
    id: `${category}-extra-${sku.toLowerCase()}`,
    category,
    rank,
    ...
    buyLabel: "PChome",
    specs,
    description: `${brand} ${model} 是${copy.label}類的補充比較型號，依 2026-07-07 通路頁面整理售價、圖片與核心規格。`,
    pros: copy.pros,
    cons: copy.cons,
...
function robotPchomeProduct(row) {
  ...
  return {
    ...
    buyLabel: "PChome",
    specs: row.specs,
    description: `${row.brand} ${row.model} 是${tier.label}級掃拖機器人，這筆以 2026-07-07 台灣通路可查售價與規格整理。`,
...
const flagshipRobotProducts = [
  robotPchomeProduct({
    ...
    recommendation: "本類 Top Pick：把機械手臂、超薄機身與熱洗基站放在同一台，最適合想看當代旗艦天花板的人。",
    score: 96,
    tags: ["旗艦", "機械手臂", "零纏繞"],
  }),
  robotPchomeProduct({
    ...
    name: "聲波騎士強震增壓旗艦機皇",
    price: 37480,
    image: "/items/DMBL1CA900K6HLE/000001_1783052009.jpg",
    sku: "DMBL1C-A900K6HLE",
    specs: ["聲波恆濕拖地", "100 度熱水洗", "雙門檻越障 4.5+4.3cm", "旗艦機皇"],
    score: 95,
    tags: ["旗艦", "聲波拖地", "高越障"],
  }),
  robotPchomeProduct({
  ...
  robotPchomeProduct({
    ...
    name: "AI 藍光辨識超薄掃拖旗艦機",
    price: 27980,
    image: "/items/DMBL3EA900JUP4D/000001_1780033507.jpg",
    sku: "DMBL3E-A900JUP4D",
    specs: ["7.95cm 超薄", "36000Pa", "AI 藍光辨識", "旗艦掃拖"],
    score: 93,
    tags: ["旗艦", "高吸力", "AI 辨識"],
  }),
  robotPchomeProduct({
    id: "robot-dreame-d30-ultra",
    rank: 9,
    tier: "subflagship",
    brand: "Dreame",
    model: "D30 Ultra",
    name: "全能掃拖機器人",
    price: 11980,
    image: "/items/DMBL3EA900JY43L/000001_1780035614.jpg",
    sku: "DMBL3E-A900JY43L",
    specs: ["25000Pa", "自動熱風烘乾", "LDS 雷射避障", "全能基站"],
    score: 88,
    tags: ["次旗艦", "高 CP", "熱風烘乾"],
  }),
  robotPchomeProduct({
