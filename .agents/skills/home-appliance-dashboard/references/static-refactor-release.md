...
- Preserve script order: `config.js`, utility/logic modules, `product-loader.js`, then `main.js`.
...
curl -I https://river-ye.github.io/home-appliance-dashboard/assets/js/config.js
curl -I https://river-ye.github.io/home-appliance-dashboard/products/tv.js
```
