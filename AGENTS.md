...
- 網站由現有 25 類資料產生 25 個 `/categories/<id>/` 靜態分類指南頁；不建立 658 個重複商品事實的薄內容頁。
...
- 頁面目前標示主要資料擷取日為 2026-07-15；本日以 658 筆清單全量重查價格、購買連結、圖片、史低來源與停產狀態。台灣商品優先台灣可信通路，16 筆海外商品才比較海外通路。好市多補充資料查核日為 2026-07-15，目前好市多/Costco 候選共 64 筆，每類最多 3 筆。
...
- 外幣匯率來源目前為 ExchangeRate-API；最新批次為 2026-07-15 00:02 UTC：USD/TWD 32.148091、GBP/TWD 43.035460、EUR/TWD 36.708624、JPY/TWD 0.198235、CNY/TWD 4.740188。
