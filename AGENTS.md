...
- 頁面目前標示主要資料擷取日為 2026-07-22；最新一輪於 2026-07-22 07:09（台灣時間；2026-07-21 23:09 UTC）以 666 筆基準清單全量重查價格、購買連結、最終 668 張圖片、438 筆 `found` 史低來源、匯率與原廠停產狀態。台灣商品優先台灣可信通路，外幣商品統一使用 2026-07-21 00:02 UTC 批次換算。
