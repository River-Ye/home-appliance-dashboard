...
- 頁面目前標示主要資料擷取日為 2026-07-13；本輪已全量重查 661 筆可信新品價格與購買連結，台灣商品優先台灣可信通路，16 筆海外商品才比較海外通路。好市多補充資料查核日為 2026-07-13，目前好市多/Costco 候選共 64 筆，每類最多 3 筆。
- 本輪負評補查重跑 612 筆原先完全沒有負面候選的商品；36 筆既有 `common_issue` 與 13 筆已有少量負面證據者保留原研究內容，未重新搜尋。
- 外幣匯率來源目前為 ExchangeRate-API，匯率時間為 2026-07-12 00:02 UTC。
