...
- 網站由現有 25 類資料產生 25 個 `/categories/<id>/` 靜態分類指南頁；不建立 662 個重複商品事實的薄內容頁。
...
- 頁面目前標示主要資料擷取日為 2026-07-16；本日以原有 658 筆清單全量重查價格、購買連結、圖片、史低來源與停產狀態，先納入 4 款新品增為 662 筆，夜間再以 1 款新品替換 1 款原廠明示停產商品。台灣商品優先台灣可信通路，16 筆海外商品才比較海外通路。好市多補充資料查核日為 2026-07-16，目前好市多/Costco 候選共 64 筆，每類最多 3 筆。
...
- 外幣匯率來源目前為 ExchangeRate-API；最新批次為 2026-07-16 00:02 UTC：USD/TWD 32.190284、GBP/TWD 43.367994、EUR/TWD 36.855151、JPY/TWD 0.198515、CNY/TWD 4.749024；16 筆外幣商品已同步重算。
