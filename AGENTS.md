...
- 網站由現有 25 類資料產生 25 個 `/categories/<id>/` 靜態分類指南頁；不建立 667 個重複商品事實的薄內容頁。
...
- 頁面目前標示主要資料擷取日為 2026-07-19；最新一輪於 2026-07-19 06:27（台灣時間；2026-07-18 22:27 UTC）以 666 筆基準清單全量重查價格、購買連結、667 張圖片、438 筆 `found` 史低來源、匯率與原廠停產狀態。台灣商品優先台灣可信通路，17 筆海外商品才比較海外通路；好市多補充資料查核日同步為 2026-07-19，目前好市多/Costco 候選共 64 筆，每類最多 3 筆。
...
- 外幣匯率來源目前為 ExchangeRate-API；最新批次為 2026-07-18 00:02 UTC：USD/TWD 32.363505、GBP/TWD 43.50892535451363、EUR/TWD 37.010253337252、JPY/TWD 0.1992826466223994、CNY/TWD 4.770154594638255；17 筆外幣商品已同步重算。
