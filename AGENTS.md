...
- 網站由現有 25 類資料產生 25 個 `/categories/<id>/` 靜態分類指南頁；不建立 664 個重複商品事實的薄內容頁。
...
- 頁面目前標示主要資料擷取日為 2026-07-17；最新一輪於 2026-07-17 12:49（台灣時間；2026-07-17 04:49 UTC）以 664 筆清單全量重查價格、購買連結、圖片、437 筆 `found` 史低來源與原廠停產狀態。台灣商品優先台灣可信通路，17 筆海外商品才比較海外通路；好市多補充資料查核日仍為 2026-07-17，目前好市多/Costco 候選共 64 筆，每類最多 3 筆。
- 本輪更新 66 筆價格（5 筆降價、61 筆漲價）、5 筆購買連結、2 張同型號來源圖片與 3 筆可公開驗證新史低。Panasonic F-H14GND-K 的失效 momo 頁改為 PChome 同型號現貨頁，現價與史低下修至 NT$2,990；Samsung RT22M4015S8/TW 改用 Yahoo 自營同型號現貨頁，現價與史低下修至 NT$11,900；SHARP FU-J41T-W 新增 NT$5,888 可重現史低。664 張圖片皆可讀取，最終 438 筆 `found`、226 筆 `not_found`；14 筆 PChome Qty 0 與 Yahoo 明示售罄商品只保留追蹤，沒有新增原廠停產或需立即納入的新品。
