...
- 頁面目前標示主要資料擷取日為 2026-07-21；最新一輪於 2026-07-21 08:48（台灣時間；2026-07-21 00:48 UTC）以 666 筆基準清單全量重查價格、購買連結、666 張圖片、437 筆 `found` 史低來源、匯率與原廠停產狀態。台灣商品優先台灣可信通路，17 筆海外商品才比較海外通路；好市多補充資料查核日同步為 2026-07-21，目前好市多/Costco 候選共 64 筆，每類最多 3 筆。
