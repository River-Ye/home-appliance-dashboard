...
- 頁面目前標示主要資料擷取日為 2026-07-20；最新一輪於 2026-07-20 06:27（台灣時間；2026-07-19 22:27 UTC）以 667 筆基準清單全量重查價格、購買連結、667 張圖片、438 筆 `found` 史低來源、匯率與原廠停產狀態。台灣商品優先台灣可信通路，17 筆海外商品才比較海外通路；好市多補充資料查核日同步為 2026-07-20，目前好市多/Costco 候選共 64 筆，每類最多 3 筆。
