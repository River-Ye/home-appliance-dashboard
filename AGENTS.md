...
- 頁面目前標示主要資料擷取日為 2026-07-22；最新一輪於 2026-07-22 08:42（台灣時間；2026-07-22 00:42 UTC）完成 668 筆商品複核。PChome 現價應優先採公開折扣價 `Price.Low`，沒有正值時才使用 `Price.P`；相較 2026-07-21 基準清單共有 33 筆既有商品異動（23 筆降價、10 筆漲價）。
- 本輪保留已納入的 Dyson HJ10 與 LG WD-S2220B，補正 HJ10 官方限時價、購買頁、圖片與正式發售日，以及 WD-S2220B 官方發表日。總數維持 668 筆，25 類皆至少 20 筆；逐類複核沒有找到 2026-07-21 後真正新上市且需立即納入的商品。
- 401 筆 PChome exact-model 頁已重查，18 筆 Qty 0 只列追蹤；668 張圖片皆可讀取。438 筆 `found` 史低來源中 335 筆可自動重現、55 筆被來源阻擋、48 筆無法自動確認 exact model，保留原證據且未臆測失效。3 筆停產文字掃描候選經原頁覆核皆為誤判，沒有移除商品。
- ExchangeRate-API 最新批次仍為 2026-07-21 00:02 UTC，USD/TWD 為 32.327985，沒有較新匯率可寫回。完整逐筆結果保存於 `catalog_maintenance_2026-07-22.json`。
